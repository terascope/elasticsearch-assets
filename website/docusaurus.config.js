module.exports = {
    ...
    baseUrl: '/elasticsearch-assets/',
    organizationName: 'terascope',
    projectName: 'elasticsearch-assets',
    scripts: [
        'https://buttons.github.io/buttons.js',
        'https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js',
        '/elasticsearch-assets/js/copy-code-block.js'
    ],
    stylesheets: [
        {
            href: '/elasticsearch-assets/css/custom.css',
            type: 'text/css',
            rel: 'stylesheet'
        }
    ],
    ...
    themeConfig: {
        ...
        navbar: {
            ...
            items: [
                ...
                {
                    href: 'https://github.com/terascope/elasticsearch-assets',
                    label: 'GitHub',
                    position: 'left'
                },
                {
            ...
            links: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: 'Github',
                            to: 'https://github.com/terascope/elasticsearch-assets',
                        },
                        {
        ...
        algolia: {
            ...
            indexName: 'terascope_teraslice_elasticsearch-assets',
