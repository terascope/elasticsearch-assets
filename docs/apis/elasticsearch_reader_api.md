...
This api is the core of the [elasticsearch reader](../operations/elasticsearch_reader.md). This contains all the same behavior, functionality and configuration of that reader
